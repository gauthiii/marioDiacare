...
class Coin(EntityBase):
    def __init__(self, screen, spriteCollection, x, y, gravity=0):
        ...
        self.images = [
            pygame.transform.scale(pygame.image.load('./img/icons/Apple.png').convert_alpha(), (32, 32*0.97)),
            pygame.transform.scale(pygame.image.load('./img/icons/Apple1.png').convert_alpha(), (32, 32*0.97)),
            pygame.transform.scale(pygame.image.load('./img/icons/Apple2.png').convert_alpha(), (32, 32*0.97))
        ]
